(function($) {
  $.fn.SocialCounter = function(options) {
    ...
    function pinterest(){
      ...
      $.ajax({
        ...
        success: function(data) {   
          ...
          $('#wrapperLALA .item.pinterest .count').append(k); 
          $('#wrapperLALA .item.pinterest').attr('href','https://pinterest.com/'+settings.pinterest_user);
          getTotal(followers); 
        } 
      }); 
    }
    function dribbble(){
      ...
      $.ajax({
        ...
        success: function(data) {   
          ...
          var k = kFormatter(followers);
          $('#wrapperLALA .item.dribbble .count').append(k); 
          $('#wrapperLALA .item.dribbble').attr('href','https://dribbble.com/'+settings.dribbble_user);
          getTotal(followers); 
        } 
      }); 
    }
    function facebook(){
      ...
      $.ajax({
        ...
        success: function(data) {   
          ...
          var k = kFormatter(followers);
          $('#wrapperLALA .item.facebook .count').append(k); 
          $('#wrapperLALA .item.facebook').attr('href','https://facebook.com/'+settings.facebook_user);
          getTotal(followers); 
        } 
      }); 
    }
    function instagram(){
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          var k = kFormatter(followers);
          $('#wrapperLALA .item.instagram .count').append(k);
          $('#wrapperLALA .item.instagram').attr('href','https://instagram.com/'+settings.instagram_user);
          getTotal(followers); 
        }
      });
    }
             ...
             if(settings.instagram_user_sandbox == item.username){
               $.ajax({
                 ...
                 success: function(data) {
                   var followers = parseInt(data.data.counts.followed_by);
                   var k = kFormatter(followers);
                   $('#wrapperLALA .instagram_sandbox .count').append(k);
                   $('#wrapperLALA .item.instagram_sandbox').attr('href','https://instagram.com/'+settings.instagram_user_sandbox);
                   getTotal(followers); 
                 }
               });
             } 
    ...
    function google(){
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          var k = kFormatter(followers);
          $("#wrapperLALA .item.google .count").append(k);
          $('#wrapperLALA .item.google').attr('href','https://plus.google.com/'+settings.google_plus_id);
          getTotal(followers); 
        }
      });
    }
      ...
      $.ajax({
        ...
        success: function(data) {  
         console.log(data); return;
          ...
          $('#wrapperLALA .item.youtube .count').append(k); 
          $('#wrapperLALA .item.youtube').attr('href','https://youtube.com/'+settings.youtube_user);
    ...
    function soundcloud(){
      ...
      $.ajax({
        ...
        success: function(data) {   
          var followers = parseInt(data.followers_count);
          var k = kFormatter(followers);
          $('#wrapperLALA .item.soundcloud .count').append(k); 
          $('#wrapperLALA .item.soundcloud').attr('href',data.permalink_url);
          getTotal(followers); 
        } 
      }); 
    }
    function vimeo(){
      ...
      $.ajax({
        ...
        success: function(data) {   
          ...
          $('#wrapperLALA .item.vimeo .count').append(followers).digits(); 
          $('#wrapperLALA .item.vimeo').attr('href','https://vimeo.com/'+settings.vimeo_user);
          getTotal(followers); 
        } 
      }); 
    }
    function twitter(){
      ...
      //References
      //rhttp://stackoverflow.com/questions/17409227/follower-count-number-in-twitte
      ...
      $.ajax({
        ...
        success: function(data) {   
          ...
          $('#wrapperLALA .item.twitter .count').append(followers).digits(); 
          $('#wrapperLALA .item.twitter').attr('href','https://twitter.com/'+settings.twitter_user);
          getTotal(followers); 
        } 
      }); 
    }
    function github(){
      ...
      $.ajax({
        ...
        success: function(data) {   
          var followers = parseInt(data.followers);
          var k = kFormatter(followers);
          $('#wrapperLALA .item.github .count').append(k); 
          $('#wrapperLALA .item.github').attr('href','https://github.com/'+settings.github_user);
          getTotal(followers); 
        } 
      }); 
    }
    function behance(){
      ...
      $.ajax({
        ...
        success: function(data) {   
          ...
          var k = kFormatter(followers);
          $('#wrapperLALA .item.behance .count').append(k); 
          $('#wrapperLALA .item.behance').attr('href','https://behance.net/'+settings.behance_user);
          getTotal(followers); 
        } 
      }); 
    }
    function vine(){
      $.ajax({
        ...
        success: function(data) {
          var followers = parseInt(data.followers);
          var k = kFormatter(followers);
          $('#wrapperLALA .item.vine .count').append(k); 
          $('#wrapperLALA .item.vine').attr('href','https://vine.co/u/'+settings.vine_user);
          getTotal(followers); 
        } 
      });
    }
    function vk(){
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          var k = kFormatter(followers);
          $('#wrapperLALA .item.vk .count').append(k); 
          $('#wrapperLALA .item.vk').attr('href','https://vk.com/id'+settings.vk_id);
          getTotal(followers); 
        } 
      });
    }
        ...
        success: function(data) {
          ...
          $.ajax({
            ...
            success: function(data) {    
              ...
              var k = kFormatter(followers);
              $('#wrapperLALA .item.foursquare .count').append(k); 
              $('#wrapperLALA .item.foursquare').attr('href','https://foursquare.com/'+settings.foursquare_user);
              getTotal(followers); 
            } 
          });
        } 
    ...
    function linkedin(){
      $.ajax({
        ...
        success: function(data){
          ...
          $('#wrapperLALA .item.linkedin .count').append(k); 
          $('#wrapperLALA .item.linkedin').attr('href',data.publicProfileUrl);
    ...
    function tumblr(){
      $.ajax({
        ...
        success: function(data) {
          var followers = parseInt(data.followers);
          var k = kFormatter(followers);
          $('#wrapperLALA .item.tumblr .count').append(k); 
          $('#wrapperLALA .item.tumblr').attr('href','https://'+settings.tumblr_username+'.tumblr.com');
          getTotal(followers); 
        } 
      });
    }
    function twitch(){
      $.ajax({
        ...
        success: function(data) {
          var followers = parseInt(data.followers);
          var k = kFormatter(followers);
          $('#wrapperLALA .item.twitch .count').append(k); 
          $('#wrapperLALA .item.twitch').attr('href','https://www.twitch.tv/'+settings.twitch_username+'/profile');
          getTotal(followers); 
        } 
      });
    }
    ...
    function linkClick(){
      $('#wrapperLALA .item').attr('target','_blank');
    }
    linkClick();
