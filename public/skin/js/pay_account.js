$(function () {
    ...
    $(document).on('click', '.mode', function () {
        ...
        else if ($(this).attr('data-payment-mode') == 'pg') {
    ...
    $(document).on('click', '#request-order', function () {
        ...
        $.ajax({
            ...
            data: {mode: deposit_mode, bank: bank, reference_number: reference_number, amount: amount, order_id: order_id, txn_id: txn_id},
    ...
    $(document).on('click', '#pg-request-order', function () {
        ...
        $.ajax({
            type: "post",
            dataType: 'json',
            url: CONF.baseurl + "/pg/makepayment",
            data: {amount: amount, sp_key: TOOLS.sp_key},
            success: function (response) {
                if (response.statuscode == 'SUCC') {
