    ...
    $(document).on('click', '#sendOtp', function () {
        ...
        if (mobile) {
            $.ajax({
                ...
                data: {'mobile': mobile, 'dial_code': dial_code},
                beforeSend: function () {
    ...
    $(document).on('click', '#send_otp', function () {
        ...
        if (mobile) {
            $.ajax({
                type: 'post',
                dataType: 'json',
                url: CONF.baseurl + '/sendOtp',
                data: {'mobile': mobile, 'dial_code': dial_code},
                beforeSend: function () {
                    _this.html(TOOLS.Loader).attr('disabled', true);
                },
                success: function (response) {
                    _this.html('Resend OTP').removeAttr('disabled');;
                    if (response.statuscode == 'SUCC') {
            ...
            showErrorNotification('please enter mobile number')
        }
    });
